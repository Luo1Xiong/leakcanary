...
class AndroidResourceIdNamesTest {
    ...
    @Test
    fun `saveToMemory call is cached`() {
    ...
    @Test
    fun `AndroidResourceIdNames available in heap dump when saveToMemory is called`() {
        AndroidResourceIdNames.saveToMemory(
    ...
    @Test
    fun `AndroidResourceIdNames not available in heap dump when saveToMemory is not called`() {
        dumpAndReadHeap { resIdNames ->
    ...
    @Test
    fun `saveToMemory stores and retrieves resource id`() {
    ...
    @Test
    fun `id type starts after layout`() {
    ...
    @Test
    fun `two consecutive id resource ids`() {
        val firstIdResourceId = FIRST_APP_RESOURCE_ID
