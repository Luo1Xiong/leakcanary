...
import shark.LegacyHprofTest.WRAPS_ACTIVITY.*
...
class LegacyHprofTest {
    ...
    @Test
    fun gcRootReferencesUnknownObject() {
    ...
    @Test
    fun `AndroidObjectInspectors#CONTEXT_FIELD labels Context fields`() {
    ...
    @Test
    fun androidOCountActivityWrappingContexts() {
