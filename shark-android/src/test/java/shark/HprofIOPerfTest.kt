...
class HprofIOPerfTest {
    ...
    @Test
    fun `HeapObjectArray#readByteSize() reads only size of array`() {
    ...
    @Test
    fun `HeapObjectArray#readByteSize() correctly reads size of array`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `HeapPrimitiveArray#readByteSize() reads only size of array`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
        val arrayId = hprofFile.openHeapGraph().use { graph ->
    ...
    @Test
    fun `HeapPrimitiveArray#readByteSize() correctly reads size of array`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
        hprofFile.openHeapGraph().use { graph ->
    ...
    @Test
    fun `HeapInstance#byteSize reads 0 bytes`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `consecutive call to HeapObject#readRecord() reads 0 bytes`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `HeapObject#readRecord() reads 0 bytes when reading from LRU`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `HeapObject#readRecord() reads bytes when reading evicted object`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `analyze() creates 4 separate sources`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `header parsing requires only one segment`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `fast scan pre indexing is a full file scan`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `indexing is a full file scan`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `freeze leak_asynctask_o hprof random access metrics`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
    ...
    @Test
    fun `freeze leak_asynctask_m hprof random access metrics`() {
    ...
    @Test
    fun `freeze leak_asynctask_pre_m hprof random access metrics`() {
