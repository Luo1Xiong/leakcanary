...
class HprofRetainedHeapPerfTest {
    ...
    @Test
    fun `freeze retained memory when indexing leak_asynctask_o`() {
    ...
    @Test
    fun `freeze retained memory when indexing leak_asynctask_m`() {
    ...
    @Test
    fun `freeze retained memory through analysis steps of leak_asynctask_o`() {
        val hprofFile = "leak_asynctask_o.hprof".classpathFile()
