...
class DatabaseMigrationTest {
    ...
    @Test
    fun v24_heap_dumps_can_be_deserialized() {
        DB_V24 upgrade {
    ...
    @Test
    fun v24_has_5_sticky_class_and_3_java_frame_gc_roots() {
        DB_V24 upgrade {
            val allLeakTraces = HeapAnalysisTable.retrieveAll(this)
                    .map { HeapAnalysisTable.retrieve<HeapAnalysisSuccess>(this, it.id)!! }
                    .flatMap { analysis ->
