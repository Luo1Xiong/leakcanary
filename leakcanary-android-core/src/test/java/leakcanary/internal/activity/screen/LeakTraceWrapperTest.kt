...
class LeakTraceWrapperTest {
    ...
    @Test
    fun `short string stays identical`() {
        val string = "12\n"
    ...
    @Test
    fun `string at width stays identical`() {
        val string = "1234\n"
    ...
    @Test
    fun `string at width no newline stays identical`() {
        val string = "1234"
    ...
    @Test
    fun `string wrapped without newline stays has no trailing newline`() {
        val string = "12 34"
    ...
    @Test
    fun `wrap line at space removing space`() {
        val string = "12 34\n"
    ...
    @Test
    fun `wrap line at space keeps prefix`() {
        val prefix = "│   "
    ...
    @Test
    fun `wrap line at space keeps non breaking space`() {
        val string = "\u200B 12 34\n"
    ...
    @Test
    fun `wrap line at period keeping period`() {
        val string = "12.34\n"
    ...
    @Test
    fun `two periods wraps at last period`() {
        val string = "1.2.34\n"
    ...
    @Test
    fun `no space or period is wrapped at max width`() {
        val string = "1234\n"
    ...
    @Test
    fun `two consecutive periods wraps at last period`() {
        val string = "12..34\n"
    ...
    @Test
    fun `period and space wraps at last`() {
        val string = "12. 34\n"
    ...
    @Test
    fun `space and period wraps at last`() {
        val string = "12 .34\n"
    ...
    @Test
    fun `period and separated space wraps at last`() {
        val string = "1.2 34\n"
    ...
    @Test
    fun `several spaces are all removed`() {
        val string = "12  34\n"
    ...
    @Test
    fun `several periods all keeping period`() {
        val string = "12...34\n"
        val wrapped = LeakTraceWrapper.wrap(string, 4)
        assertThat(wrapped).isEqualTo("12..\n.34\n")
    }
    ...
    @Test
    fun `prefix applied to all lines`() {
        val prefix = "│  "
        val part1 = "A word"
        val part2 = "and a"
        val part3 = "pk.g"
...
"""
    ...
    @Test
    fun `underline within multiline string`() {
        val string = """
