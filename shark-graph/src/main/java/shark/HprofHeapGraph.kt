    ...
    override val instances: Sequence<HeapInstance>
        get() {
            ...
            return index.indexedInstanceSequence()
                    .map {
                        val objectId = it.first // INSTANCE ID
                        val indexedObject = it.second
                        val a = HeapInstance(this, indexedObject, objectId, objectIndex++)

//                        println("construct a heapInstance a: ${a.instanceClassName} ${a.instanceClassSimpleName}")
//                        if (a.instanceClassName.contains("bitmap",true)){
//                            println("construct a heapInstance of bitmap: ${a.byteSize} ${a.recordSize}")
//                        }
                        a
                    }
        }
    ...
    private fun wrapIndexedObject(
        ...
        return when (indexedObject) {
            ...
            is IndexedInstance -> {
                val a = HeapInstance(this, indexedObject, objectId, objectIndex)
//                println("construct a heapInstance b: ${a.instanceClassName}")
                a
            }
    ...
    companion object {
        ...
        fun indexHprof(
            ...
            val index = HprofIndex.indexRecordsOf(FileSourceProvider(hprof.file), hprof.header, proguardMapping, indexedRootTags)
