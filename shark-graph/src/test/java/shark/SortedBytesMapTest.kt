...
class SortedBytesMapTest {
    ...
    @Test
    fun writeAndReadTruncatedLongValue() {
    ...
    @Test
    fun fourEntriesWithLongKey1ByteValueSorted() {
    ...
    @Test
    fun fourEntriesWithLongKey3ByteValueSorted() {
    ...
    @Test
    fun largeRandomArrayIntKey3ByteValueSorted() {
    ...
    @Test
    fun largeRandomArrayLongKey3ByteValueSorted() {
    ...
    @Test
    fun largeRandomArrayLongKey7ByteValueSorted() {
