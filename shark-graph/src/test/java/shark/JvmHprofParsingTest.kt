...
class JvmHprofParsingTest {
    ...
    @Test
    fun `JVM object array class name is translated to brackets`() {
    ...
    @Test
    fun `JVM multi dimension object array class name is translated to brackets`() {
    ...
    @Test
    fun `JVM primitive wrapper array class name is translated to brackets`() {
    ...
    @Test
    fun `JVM multi dimension wrapper primitive array class name is translated to brackets`() {
    ...
    @Test
    fun `JVM primitive array class name is translated to brackets`() {
    ...
    @Test
    fun `JVM multi dimension primitive array class name is translated to brackets`() {
