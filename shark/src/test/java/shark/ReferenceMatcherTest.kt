...
class ReferenceMatcherTest {
    ...
    @Test
    fun allPathsExcluded_ShortestWins() {
        hprofFile.writeTwoPathsToInstance()
    ...
    @Test
    fun noPathToInstanceNeverReachable() {
        hprofFile.writeTwoPathsToInstance()
    ...
    @Test
    fun overrideSuperclassExclusion() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["ref"] =
    ...
    @Test
    fun nativeGlobalVariableLibraryLeak() {
        hprofFile.dump {
    ...
    @Test
    fun nativeGlobalVariableShortestPathExcluded() {
        hprofFile.dump {
