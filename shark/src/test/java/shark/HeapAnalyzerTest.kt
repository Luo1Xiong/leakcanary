...
class HeapAnalyzerTest {
    ...
    @Test
    fun findMultipleIdenticalLeaks() {
    ...
    @Test
    fun localVariableLeakShortestPathGoesLast() {
    ...
    @Test
    fun nativeGlobalVariableApplicationLeak() {
        hprofFile.dump {
