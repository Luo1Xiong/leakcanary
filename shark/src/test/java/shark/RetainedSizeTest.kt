...
class RetainedSizeTest {
    ...
    @Test
    fun leakingInstanceWithPrimitiveType() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["shortestPath"] = "Leaking" watchedInstance {
    ...
    @Test
    fun leakingInstanceWithPrimitiveArray() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["shortestPath"] = "Leaking" watchedInstance {
    ...
    @Test
    fun leakingInstanceWithInstance() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["shortestPath"] = "Leaking" watchedInstance {
    ...
    @Test
    fun leakingInstanceWithPrimitiveWrapper() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["shortestPath"] = "Leaking" watchedInstance {
    ...
    @Test
    fun leakingInstanceWithPrimitiveWrapperArray() {
        hprofFile.dump {
    ...
    @Test
    fun leakingInstanceWithObjectArray() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["shortestPath"] = "Leaking" watchedInstance {
    ...
    @Test
    fun leakingInstanceWithDeepRetainedObjects() {
        hprofFile.dump {
            "GcRoot" clazz {
                staticField["shortestPath"] = "Leaking" watchedInstance {
    ...
    @Test
    fun leakingInstanceNotDominating() {
        hprofFile.dump {
    ...
    @Test
    fun leakingInstanceWithSuperClass() {
        hprofFile.dump {
    ...
    @Test
    fun leakingInstanceDominatedByOther() {
        hprofFile.dump {
            "GcRoot" clazz {
    ...
    @Test
    fun crossDominatedIsNotDominated() {
        hprofFile.dump {
            val fortyTwo = string("42")
            "GcRoot1" clazz {
