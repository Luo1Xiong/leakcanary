...
class ShallowSizeCalculatorTest {
    ...
    @Test
    fun `empty class has instance size 0`() {
        hprofFile.dump {
            "SomeClass" instance {}
        }
    ...
    @Test
    fun `class with static field has instance size 0`() {
        hprofFile.dump {
            "SomeClass" instance {
    ...
    @Test
    fun `class with int field has instance size 4`() {
        hprofFile.dump {
            "SomeClass" instance {
    ...
    @Test
    fun `empty class has size EMPTY_CLASS_SIZE`() {
        hprofFile.dump {
            "SomeClass" clazz {}
        }
    ...
    @Test
    fun `class with static int field has class size that includes field`() {
        hprofFile.dump {
            "SomeClass" clazz {
