 ...
 * to a leaking object. Shark prioritizes(重视) paths that don't go through known
...
//        PrettyLogger.invokeTrack()
        return leakTraceAsString(showLeakingStatus = true)
    }
    ...
    private fun leakTraceAsString(showLeakingStatus: Boolean): String {
        print("leakcanary:leakTraceAsString aaa\n")
        var result = """
        ┬───
